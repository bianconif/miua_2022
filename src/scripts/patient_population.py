...
from stability_radiomics_features_lung_ct.src.utilities import metadata_from_dicom_folder
...
scans_metadata_csv = config['scans_metadata_file']

#Store the nodules metadata here
nodules_metadata_csv = config['nodules_metadata_file']
...
patient_population = pd.read_csv(scans_metadata_csv)
